<template>
  <div class="relative">
    ...
    <button class="absolute bottom-4 right-3 bg-blue-600 text-white rounded-full w-10 h-10 flex items-center justify-center hover:bg-blue-700" @click="sendMessage" :disabled="!messageText.trim()">
