<template>
  <div class="p-4">
    ...
    <div class="mb-4">
      <div class="relative">
        <input type="text" v-model="searchQuery" placeholder="Pesquisar por nome, descrição ou caminho..." class="w-full px-4 py-2 pl-10 rounded-lg border border-gray-600 bg-gray-800 text-white focus:outline-none focus:border-blue-500" autofocus/>
